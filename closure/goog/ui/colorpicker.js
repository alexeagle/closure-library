...
goog.ui.ColorPicker.prototype.setColors = function(colors) {
  // TODO(pupius): Don't add colors directly, we should add palettes and the
...
goog.ui.ColorPicker.prototype.setSize = function(size) {
  // TODO(pupius): The color picker should contain multiple palettes which will
...
goog.ui.ColorPicker.prototype.setSelectedColor = function(color) {
  // TODO(pupius): This will set the color in the first available palette that
  // contains it
  if (this.colorPalette_) {
...
goog.ui.ColorPicker.prototype.createColorPalette_ = function(colors) {
  // TODO(pupius): The color picker should eventually just contain a number of
  ...
  // TODO(pupius): Use addChild(cp, true) and remove calls to render.
  this.addChild(cp);
