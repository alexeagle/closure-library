...
goog.ui.ac.CachingMatcher = function(baseMatcher) {
   ...
   *
   * NOTE(user): The need for this is subtle. When a server result comes
...
goog.ui.ac.CachingMatcher.prototype.onBaseMatch_ = function(token, matches) {
  // NOTE(user): The user might have typed some more characters since the
  ...
  // NOTE(user): We compute a diff between the currently displayed results
