 ...
 *
 * TODO: Reference more thorough documentation when it's available.
 */
...
// NOTE: The debug DOM loader was included in base.js as an original way
 ...
 * transpilation.
 */
// NOTE: we could expand this to accept a language level to bypass
...
goog.transpile_ = function(code, path, target) {
  ...
  if (!transpile) {
    ...
    transpile = jscomp.transpile = function(code, path) {
      // TODO: figure out some way to get this error to show up
...
goog.getUid = function(obj) {
  ...
  // TODO: UUIDs are broken for ctors with class-side inheritance.
...
goog.defineClass = function(superClass, def) {
  // TODO: consider making the superClass an optional parameter.
...
// TODO: share these values with the goog.object
/**
...
// TODO: share this function with the goog.object
/**
...
goog.defineClass.applyProperties_ = function(target, source) {
  // TODO: update this to support ES5 getters/setters
...
if (!COMPILED && goog.DEPENDENCIES_ENABLED) {
  ...
  goog.Transpiler.prototype.transpile = function(code, path) {
    // TODO: We should delete goog.transpile_ and just have this
...
goog.createTrustedTypesPolicy = function(name) {
  var policy = null;
  // TODO: Remove window.TrustedTypes variant when the newer API ships.
