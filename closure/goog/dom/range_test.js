...
// TODO: Test iteration over a strange document fragment.
...
testSuite({
  ...
  testTableRange() {
    ...
    // TODO: On IE the TR is included, on FF it is not.
  ...
  testUnorderedListRange() {
    ...
    // TODO: On IE the UL is included, on FF it is not.
    // assertEquals('Selection should have correct valid html',
  ...
  testOrderedListRange() {
    ...
    // TODO: On IE the OL is included, on FF it is not.
    // assertEquals('Selection should have correct valid html',
    //    '<li>1</li><li>2</li>', normalizeHtml(range.getValidHtml()));
  ...
  testRemovePartialContents() {
    ...
    // TODO: Fix the following edge cases:
  ...
  testSurroundContents() {
    ...
    // TODO: Ensure the range stays in a reasonable state.
  },
