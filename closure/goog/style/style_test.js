...
testSuite({
  ...
  testSetPosition() {
    ...
    // TODO: IE errors if you set these values.  Should we make setStyle
  ...
  testSetBorderBoxSize() {
    ...
    // NOTE: I'm not really sure why IE7 is special here.
  ...
  testGetVisibleRectForElement() {
    ...
    // NOTE: For iframe, the clipping viewport is always the iframe
